...
app.config['MYSQL_DATABASE_HOST'] = 'cumhur-database-1.ce2bgallfsqq.us-east-1.rds.amazonaws.com'   # yan tarafa RDS oluşunca ordaki enpointi yaz 'PLEASE WRITE YOUR DATABASE ENDPOINT HERE'
...
#  app.run(debug=True)               # yerel bilgisayarda da çalıştırmak için bu aktif olacak
   app.run(host='0.0.0.0', port=80)  # ec2 da çalıştırmak için bu aktif olacak
