...
@app.route('/')
def home():
    return render_template('main.html', name='Cumhur')
...
# Add a statement to run the Flask application which can be reached from any host on port 80. DİKKAT: Sayfa EC2 da çalışcak şekilde ayarlanmış onun için pc de çalıştırırken son iki satırı değiştirdik. # bu isareti alt satıra koyduk.
# 44. satırı bu şekilde değiştirirsek diger uygulamalarda EC2 da çalışır.
